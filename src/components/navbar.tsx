...
const Navbar = () => {
    return (
      <nav className="flex justify-between sm:justify-normal md:justify-normal items-center  shadow-md h-24">
        ...
        <div className="flex gap-4 flex-1 justify-between px-[3rem]">
          <div className="second-col flex gap-2">
            <div className="search flex items-center border px-3 py-1 rounded-[20px] border-gray-600 gap-2 text-[1rem] sm:text-[0.9rem] md:text-[0.9rem]">
              <CiSearch className="text-gray-800"/>
            <input
            type="text"
            placeholder="Search"
            className="flex-1 outline-0 border-0 hidden sm:flex md:flex"
          />
            </div>
          ...
          <div className="third-col hidden sm:flex md:flex gap-2 items-center">
