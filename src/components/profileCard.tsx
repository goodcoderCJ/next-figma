   ...
   const toggleHeart = ()=>{
    ...
    return (
      <div className="rounded-lg  shadow-md grid grid-cols-[10%_25%_5%_20%_5%_12.5%_12.5%_10%] grid-rows-[24%_6%_4%_8%_8%_4%_20%_9%_12%_5%] pb-[1rem] mb-[1rem]">
        ...
        {verified ? <button className="bg-green-700 text-white px-4 py-1 mt-2 rounded-[20px] " onClick={()=>router.push("/profile")} >More Info</button> : <button className="bg-red-700 text-white px-4 py-1 mt-2 rounded-[20px] " onClick={()=>router.push("/profile")}>More Info</button>}
